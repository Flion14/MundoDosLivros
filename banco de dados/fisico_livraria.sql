...
INSERT INTO livro(qtd_estoque, nome, preco, cod_editora, img, promo) VALUES
	(886, "Percy Jackson e o Ladrao de Raios", 47.30, 1, "1.png", 0),

	(615, "Harry Potter E A Crianca Amaldicoada", 47.90, 2, "2.png", 0),

	(523, "O principe cruel: O Povo do Ar", 31.74, 3, "3.png", 0),

	(432, "Vermelho, branco e sangue azul", 34.89, 4, "4.png", 0),

	(654, "Heartstopper: Dois garotos, um encontro", 38.90, 4, "5.png", 0),

	(734, "Maze Runner: correr ou morrer", 32.90, 5, "6.png", 0), 

	(5483, "As cronicas de Narnia", 49.90, 6, "7.png", 0),

	(658, "Jogos Vorazes", 43.90, 2, "8.png", 0),

	(721, "Five nights at Freddys Olhos Prateados", 32.90, 1, "9.png", 0),

	(25, "Os Dois Morrem No Final", 45.90, 1, "10.png", 0),

	(234, "Harry Potter e a Pedra Filosofal", 23.49, 2, "11.png", 0),

	(644, "Harry Potter e a Camara Secreta", 51.14, 2, "12.png", 0),

	(478, "Percy Jackson e o Mar de Monstros", 43.31, 1, "13.png", 0),

	(374, "Maze Runner: prova de fogo", 41.07, 5, "14.png", 0),

	(872, "Five Nights at Freddys Os Distorcidos", 23.94, 1, "15.png", 0),

	(815, "Five Nights at Freddys a Ultima Porta", 30.90, 1, "16.png", 0);

INSERT INTO genero(descricao, img_gen) VALUES("Fantasia", "fan.png"), ("Ficcao Cientifica", "icg.png"), ("Terror", "ter.png"), ("Literatura", "lit.png"), ("Juvenil", "juv.png"), ("Romance", "rom.png"), ("Distopica", "dis.png"), ("Acao", "aca.png");

INSERT INTO genero_livro(cod_livro, cod_genero) VALUES(1, 1), (1, 2), (1, 4), (1, 5), (2, 2), (2, 4), (3, 1), (3, 2),(3, 3), (3, 4), (4, 6), (4, 5), (5, 2), (5, 5), (5, 6), (6, 2), (6, 4), (6, 7), (7, 1), (7, 2), (7, 5), (8, 1), (8, 2), (8,5), (8, 7), (8, 8), (9, 2), (9, 3), (9, 4), (9,5), (10, 2), (10, 4), (10, 5), (10, 6), (11, 2), (11, 4), (12, 2), (12, 4), (13, 1), (13, 2), (13, 4), (13, 5), (14, 2), (14, 4), (14, 7), (15, 2), (15, 3), (15, 4), (15, 5), (16, 2), (16, 3), (16, 4), (16, 5);

INSERT INTO autor_livro(cod_autor, cod_livro) VALUES(1,1), (1,13), (2,2), (2,11), (2,12), (3,3), (4,4), (5, 5), (6,6), (6,14), (7,7), (8,8), (9,9), (9,15), (9, 16), (10, 10);
